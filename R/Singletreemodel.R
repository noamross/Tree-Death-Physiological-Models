...
wp.soil = 2 #soil water potential, MPa
wp.grav = 1 #gravitational water potential, MPa, also height*density*graviational force
Ds = 1 #leaf surface moisture saturation deficit, MPa

#Define Instantaneous relationships and processes

E = G*Ds #evapotranspiration rate, in mmol s-1
wp.delta = wp.soil - (E / K) - wp.grav  #xylem pressure, mPa
P = alpha * G #photosynthetic rate, in g d-1
R = beta * S * (1 - (K / Kmax)) #allocation of carbs to xylem repair, g d-1
B = gamma * S * exp(-(-wp.delta/l.B)^k.B)# allocation of carbs to growth, g d-1
G = Gmin + (Gmax - Gmin)*exp(-(-wp.delta/l.G)^k.G) #total stomatal conductance, mmol s-1 MPa-1
