...
alpha 4 "g s MPa mmol-1 d-1" "photsynthetic rate per stomatal conductance" $\\alpha$
...
tau 0.5 "" "stomatal sensitivity to leaf water potential" $\\tau$
...
K.death 0.01 "mmol s^-1 MPa^-1" "Minimum viable xylem conductance" $K_death$
